...
# Generated from maruku-0.6.0.gem by gem2rpm -*- rpm-spec -*-
...
Requires: %{?ruby_dist_dash}rubygem(syntax) >= 1.0.0
...
* Thu Apr 28 2011 Sergio Rubio <rubiojr@frameos.org> - 0.6.0-1
- Initial package
